...
function ListingsContent({ category, title, description, accentColor, minPrice, showAestheticsBanner }: ListingsPageProps) {
    ...
    <main className="min-h-screen bg-off-white overflow-x-hidden">
      ...
      <section className="pt-28 pb-10 bg-navy">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl text-white mb-4">{title}</h1>
      ...
      {showAestheticsBanner && (
        <section className="bg-gradient-to-r from-accent-aesthetics/10 via-gold/5 to-accent-aesthetics/10 border-y border-gold/20">
          <div className="container mx-auto px-4 lg:px-8">
            <Link href="/aesthetics">
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-accent-aesthetics/20 flex items-center justify-center shrink-0">
                    <Sparkles className="w-5 h-5 text-accent-aesthetics" />
                  </div>
                  <div>
                    <p className="font-serif text-navy text-sm md:text-base">
                      Looking for <span className="text-accent-aesthetics font-semibold">Premium Luxury</span>?
                    </p>
                ...
                <div className="flex items-center gap-2 text-accent-aesthetics text-sm font-medium shrink-0">
